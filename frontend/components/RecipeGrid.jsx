...
const RecipeGrid = ( {type, value, fetchAction, backlink="/dashboard"} ) => {
    ...
    useEffect(() => {
        if(value){
            // capitalize first letter of API call
    ...
    const displayName = value?.replace(/-/g, " "); // replace hyphens with spaces for better display

    return (
        <div className='min-h-screen bg-stone-50 pt-14 pb-16 px-4'>
            <div className='container mx-auto max-w-7xl'>
                <div className='mb-8'>
                    <Link href={backlink} className='inline-flex items-center gap-2 text-stone-600 hover:text-orange-600 transition-colors mb-4'>
                ...
                {!loading && meals.length === 0 && (
                    <div className='text-center py-20'>
                        ...
                        <h3 className='text-2xl font-bold text-stone-900 mb-2'>No recipe found</h3>
